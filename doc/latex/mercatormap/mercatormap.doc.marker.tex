...
\begin{tikzpicture}
  \mrcmap[type=reference, position=48.15:11.6,
    ...
    tex width=\linewidth,tex height=4cm]{marker_mrcmarker}
  \mrcdrawmap
...
\begin{docMrcKey}[marker]{hide all but category}{=\meta{category}}{style, no default}
  ...
  \begin{tikzpicture}
    \mrcmap[tex width=4cm, tex height=4cm,
      latitude=48.14, longitude=11.57, target=none]{marker_hide}
...
\begin{tikzpicture}
  ...
  \mrcmap[type=reference, named position=unibwm,
    ...
    tex width=\linewidth,tex height=4cm]{marker_url}
  \mrcdrawmap
  \node[below,font=\fontsize{7pt}{7pt}\sffamily] at (mrcmap.south)
    {\mrcmapattribution};
  \mrcdrawnetwork
...
\begin{docMrcKey}[marker]{type}{=\meta{type}}{no default, initially |classic|}
  ...
  \item\docValue{classic}:
    ...
    \mrcmap[tex width=8cm, tex height=4cm, zoom=10,
      latitude=48.14, longitude=11.48, target=none]{marker_classic}
    \mrcdrawmap[draw=path]
  ...
  \item\docValue{pin}:
    ...
    \begin{tikzpicture}
    \mrcmap[tex width=8cm, tex height=4cm, zoom=10,
      latitude=48.14, longitude=11.48, target=none]{marker_pin}
    \mrcdrawmap[draw=path]
    \mermapsetmarker{type=pin}
    \mrcmarker{position=48.14:11.36, contents={Germering}}
  ...
  \item\docValue{pinflip}:
    ...
    \begin{tikzpicture}
    \mrcmap[tex width=8cm, tex height=4cm, zoom=10,
      latitude=48.14, longitude=11.48, target=none]{marker_pinflip}
    \mrcdrawmap[draw=path]
  ...
  \item\docValue{drop}:
    ...
    \begin{tikzpicture}
    \mrcmap[tex width=8cm, tex height=4cm, zoom=10,
      latitude=48.14, longitude=11.48, target=none]{marker_drop}
    \mrcdrawmap[draw=path]
  ...
  \item\docValue{pictodrop}:
    ...
    \begin{tikzpicture}
    \mrcmap[tex width=8cm, tex height=4cm, zoom=10,
      latitude=48.14, longitude=11.48, target=none]{marker_pictodrop}
    \mrcdrawmap[draw=path]
  ...
  \item\docValue{pictodropring}:
    ...
    \begin{tikzpicture}
    \mrcmap[tex width=8cm, tex height=4cm, zoom=10,
      latitude=48.14, longitude=11.48, target=none]{marker_pictodropring}
    \mrcdrawmap[draw=path]
  ...
  \item\docValue{knob}:
    ...
    \begin{tikzpicture}
    \mrcmap[tex width=8cm, tex height=4cm, zoom=10,
      latitude=48.14, longitude=11.48, target=none]{marker_knob}
    \mrcdrawmap[draw=path]
  ...
  \item\docValue{pictoknob}:
    ...
    \begin{tikzpicture}
    \mrcmap[tex width=8cm, tex height=4cm, zoom=10,
      latitude=48.14, longitude=11.48, target=none]{marker_pictoknob}
    \mrcdrawmap[draw=path]
  ...
  \item\docValue{pictoknobring}:
    ...
    \begin{tikzpicture}
    \mrcmap[tex width=8cm, tex height=4cm, zoom=10,
      latitude=48.14, longitude=11.48, target=none]{marker_pictoknobring}
    \mrcdrawmap[draw=path]
  ...
  \item\docValue{ringx}:
    ...
    \begin{tikzpicture}
    \mrcmap[tex width=8cm, tex height=4cm, zoom=10,
      latitude=48.14, longitude=11.48, target=none]{marker_ringx}
    \mrcdrawmap[draw=path]
  ...
  \item\docValue{markx}:
    ...
    \begin{tikzpicture}
    \mrcmap[tex width=8cm, tex height=4cm, zoom=10,
      latitude=48.14, longitude=11.48, target=none]{marker_markx}
    \mrcdrawmap[draw=path]
...
\begin{docCommand}{mrcnewmarkertype}{\marg{type name}\marg{\tikzname\ code}}
  ...
  \begin{tikzpicture}
  \mrcmap[tex width=4cm, tex height=4cm,
    latitude=48.14, longitude=11.57, target=none]{marker_xmark}
  \mrcdrawmap[draw=path]
...
\begin{docCommand}{mrcnewmarkerstyle}{\marg{style name}\marg{options}}
  ...
  \begin{tikzpicture}
  \mrcmap[tex width=8cm, tex height=4cm, zoom=10,
    latitude=48.14, longitude=11.48, target=none]{marker_markerstyle}
  \mrcdrawmap[draw=path]
  ...
  \begin{tikzpicture}
  \mrcmap[tex width=8cm, tex height=4cm, zoom=10,
    latitude=48.14, longitude=11.48, target=none]{marker_markerstyle2}
  \mrcdrawmap[draw=path]
