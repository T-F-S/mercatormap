...
\begin{docMrcKey}[supply][doc new=2026-02-17]{attribution print topplusopen}{=\meta{TT}.\meta{MM}.\meta{JJJJ}}{style}
  Specialized version of \refKey{mermap/supply/attribution print}
  as required for maps from
  \href{https://www.bkg.bund.de}{Bundesamt f\"{u}r Kartographie und Geod\"{a}sie},
  see Section~\ref{sec:maptileserver}.
  \meta{TT}, \meta{MM}, and \meta{JJJJ} have to take the values of day, month, and year
  of the download.
\begin{dispExample}
\mermapsetsupply{attribution print topplusopen=17.02.2026}
...
\begin{tikzpicture}
  \mrcmap[type=reference,latitude=48.14,longitude=11.57,
    ...
    source=opentopomap,
    tex width=\linewidth,tex height=5cm]{flex_reference_scale}
  \mrcdrawmap
...
\begin{tikzpicture}
  ...
  \mrcmap[  type = areafit, area = {munich,rio,newyork},
    ...
    flex area fit=1cm ]{flex_area_fit}
  \mrcdrawmap
  \node[below,font=\fontsize{7pt}{7pt}\sffamily] at (mrcmap.south)
        {\mrcmapattribution};
  ...
  \newcommand{\mapexampletop}[3][]{%
    ...
    \item Required attribution (\docAuxCommand{mrcmapattribution}):
      \begin{tcolorbox}[sharp corners,size=fbox,colback=yellow!8,colframe=yellow!80!gray,halign=flush left,before skip=2pt]
        \mrcmapattribution\end{tcolorbox}
    \item Required attribution for media without hyperlinks (\docAuxCommand{mrcmapattributionprint}):
      \begin{tcolorbox}[sharp corners,size=fbox,colback=yellow!8,colframe=yellow!80!gray,halign=flush left,before skip=2pt,after skip=3pt]
        \mrcmapattributionprint\end{tcolorbox}
      Replace JJJJ by year, MM by month, TT by day of the download.\\
      Also see \refKey{mermap/supply/attribution print topplusopen}
    %\par\smallskip\
    \end{itemize}
    \endgroup\par\smallskip\tikzsetnextfilename{maptiles_#3}%
    \begin{tikzpicture}
...
\clearpage
  ...
  \item\docValue{topplusopen web}:\tcbdocmarginnote{\tcbdocupdated{2026-02-17}}\\
    ...
    \end{itemize}
    \mapexampletop{topplusopen web}{topplusopen_web}

\clearpage
  \item\docValue{topplusopen web grau}:\tcbdocmarginnote{\tcbdocupdated{2026-02-17}}\\
    Tile server (TMS) of \href{https://www.bkg.bund.de}{Bundesamt f\"{u}r Kartographie und Geod\"{a}sie}.
    \begin{itemize}
    \item Covers world / Europe / Germany depending on zoom level
    \item Usage (German language): \url{https://gdz.bkg.bund.de/index.php/default/digitale-geodaten/topplusopen-produkte.html}
    \end{itemize}
    \mapexampletop{topplusopen web grau}{topplusopen_web_grau}

  \item\docValue{topplusopen web light}:\tcbdocmarginnote{\tcbdocnew{2024-07-29}\\\tcbdocupdated{2026-02-17}}\\
    Tile server (TMS) of \href{https://www.bkg.bund.de}{Bundesamt f\"{u}r Kartographie und Geod\"{a}sie}.
    \begin{itemize}
    \item Covers world / Europe / Germany depending on zoom level
    \item Usage (German language): \url{https://gdz.bkg.bund.de/index.php/default/digitale-geodaten/topplusopen-produkte.html}
    \end{itemize}
    \mapexampletop{topplusopen web light}{topplusopen_web_light}

\clearpage
  \item\docValue{topplusopen web light grau}\tcbdocmarginnote{\tcbdocnew{2024-07-29}\\\tcbdocupdated{2026-02-17}}:\\
    Tile server (TMS) of \href{https://www.bkg.bund.de}{Bundesamt f\"{u}r Kartographie und Geod\"{a}sie}.
    \begin{itemize}
    \item Covers world / Europe / Germany depending on zoom level
    \item Usage (German language): \url{https://gdz.bkg.bund.de/index.php/default/digitale-geodaten/topplusopen-produkte.html}
    \end{itemize}
    \mapexampletop{topplusopen web light grau}{topplusopen_web_light_grau}
...
\begingroup
\ExplSyntaxOn
\int_gzero_new:N \l__mermap_doc_tmpa_int
\NewDocumentCommand \cleanstep {}
{
  \bool_lazy_and:nnT
    {
      \int_compare_p:nNn \l__mermap_doc_tmpa_int > 0
    }
    {
      \int_compare_p:nNn { \int_mod:nn { \l__mermap_doc_tmpa_int }{ 2 } } = 0
    }
    {
      \clearpage
    }
  \int_gincr:N \l__mermap_doc_tmpa_int
}
\ExplSyntaxOff
...
{
\cleanstep
  \item\docValue{topplusopen \name}:\tcbdocmarginnote{\tcbdocupdated{2026-02-17}}\\
    ...
    \item Usage (German language): \url{https://gdz.bkg.bund.de/index.php/default/digitale-geodaten/topplusopen-produkte.html}
    \end{itemize}
    \mapexampletop[target=wmsmap]{topplusopen \name}{topplusopen_\name}

\cleanstep
  \item\docValue{topplusopen \name\ grau}:\tcbdocmarginnote{\tcbdocupdated{2026-02-17}}\\
    Web map server (WMS) of \href{https://www.bkg.bund.de}{Bundesamt f\"{u}r Kartographie und Geod\"{a}sie}.
    \begin{itemize}
    \item 1:\scdenom, covers Europe / Germany depending on zoom level
    \item Usage (German language): \url{https://gdz.bkg.bund.de/index.php/default/digitale-geodaten/topplusopen-produkte.html}
